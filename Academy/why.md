```cpp
1) Relieve my stress
나는 보통 00을 해 스트레스 받을때 - 왜냐면 I can 스트레스 풀리거든- 근데  
사실 I'm not the type of person who gets 스트레스를 받다-왜냐면 좀
낙천적이거든 optimistic / positive - I mean 노력해 생각하려고 긍정적으로
...
```cpp
2) Cheer up
가끔 기분 다운 될 때가 있어 – when그런 기분이 들 때 00을 해 – 그러면
치얼업 돼 – and 또한 it’s a  긍정적인 영향이 있어 나에게 – 무슨
말이냐면 it motivates me일을 더 열심히 하고 최선을 다할 수 있는 동기가
...
```
3) Kill time
킬타임할 때 주로 00을 해 – 왜냐면 사실 내가 don’t really like 시간을
낭비하는 걸 별로 안 좋아하거든? – 근데 00을 할 때는? It’s not only fun
하지만 it helps me to (스트레스에/건강을 유지) 그리고 물론 시간이 goes
