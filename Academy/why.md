```cpp
1) Relieve my stress
나는 보통 00을 해 스트레스 받을때 - 왜냐면 I can 스트레스 풀리거든- 근데 사실
I'm not the type of person who gets 스트레스를 받다-왜냐면 좀 낙천적이거든
optimistic / positive - I mean 노력해 생각하려고 긍정적으로 all the time -
하지만 사람이니까 human being. 가끔 스트레스 받지-그럴때는 in that case, 00를 해.
